...
# Labels.
LABEL maintainer="emailme@andrewkanieski.com" \
    org.label-schema.schema-version="1.0" \
    org.label-schema.build-date=$BUILD_DATE \
    org.label-schema.vcs-ref=$VCS_REF \
    org.label-schema.name="akanieski/github-runner" \
    org.label-schema.description="Dockerized GitHub Actions runner." \
    org.label-schema.url="https://github.com/akanieski/github-runner" \
    org.label-schema.vcs-url="https://github.com/akanieski/github-runner" \
    org.label-schema.vendor="Andrew Kanieski" \
    org.label-schema.docker.cmd="docker run -it akanieski/github-runner:latest"
